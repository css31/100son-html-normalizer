 ...
 * la configuration des présets sur du HTML réel sans toucher d'article.
 *
...
final class TesterPage {
	...
	public function render(): void {
		...
		echo '<p>' . esc_html__( 'Collez un fragment HTML pour voir le résultat avec votre configuration de présets. Limité à 50 Ko.', '100son-html-normalizer' ) . '</p>';

 ...
 * @wordpress/scripts pour cantoner les sources sous `assets/src/` et les
 * artefacts compilés sous `assets/build/`.
 *
 * Convention plugin :
 ...
 *
 * Tout le reste (loaders, plugins, presets Babel, externals @wordpress/*)
 * vient des défauts wp-scripts — ne PAS dupliquer ici, juste étendre.
 */
